...
const teams = [
    ...
    { name: 'Sales', href: '#', bgColorClass: 'bg-yellow-500' },
    { name: 'Customer Success', href: '#', bgColorClass: 'bg-slate-500' },
]
const projects = [
    {
        id: 1,
...
export default function Dashboard() {
    ...
    return (
        user && (
            <>
                <div className="flex min-h-full flex-1 flex-col justify-center pt-9">
                            ...
                            <div className="fixed inset-0 z-40 flex">
                                ...
                                >
                                    <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white pb-4 pt-5">
                                        ...
                                        <div className="flex flex-shrink-0 items-center px-4 pt-7">
                                            {/* <img
                    ...
                    <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pb-4 lg:pt-5">
                        <div className="flex flex-shrink-0 items-center px-6 pt-8 ">
                            <img
                                className="h-8 w-auto"
                                src="https://tailwindui.com/img/logos/mark.svg?color=purple&shade=500"
                                alt="Your Company"
                                        ...
                                        <span className="flex w-full items-center justify-between">
                                            <span className="flex min-w-0 items-center justify-between space-x-3">
                                                ...
                                                <span className="flex min-w-0 flex-1 flex-col">
                                                    <span className="truncate text-sm font-medium text-gray-900">{loggedInUser && loggedInUser.name}</span>
                                                    <span className="truncate text-sm text-gray-500">{loggedInUser && loggedInUser.name}</span>
                                                </span>
                                            </span>
                                            <ChevronUpDownIcon
                        ...
                        <main className="flex-1">
                            ...
                            <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
                                <div className="min-w-0 flex-1">
                                    <h1 className="text-lg font-medium leading-6 text-gray-900 sm:truncate">Hello </h1>
                                </div>
